        ...
        <GridStack>
          ...
          <div>
            ...
            {[{
              ...
              textEl: <p>Portmore Pines Plaza</p>
            }, {
              ...
              textEl: <p className='makeBold' style={{ color: "rgb(var(--primaryColor))" }}>alphahealth@support.com</p>
            ...
            {[{
              ...
              textEl: <p style={{ opacity: .7 }}>Portmore Pines Plaza</p>
            }, {
              divItem: <div style={{ aspectRatio: "1/1", width: ".5rem", backgroundColor: "rgb(var(--primaryColor))" }}></div>,
              textEl: <p style={{ opacity: .7 }}>{"+1 (876) 567 890"}</p>
            }, {
              divItem: <div style={{ aspectRatio: "1/1", width: ".5rem", backgroundColor: "rgb(var(--primaryColor))" }}></div>,
              textEl: <p style={{ opacity: .7 }}>alphahealth@support.com</p>
            },].map((eachItem, eachItemIndex) => {
              return (
                <div key={eachItemIndex} style={{ display: "grid", gridTemplateColumns: 'auto 1fr', alignItems: "center", gap: ".5rem" }}>
                  {eachItem.divItem}
