        ...
        <div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(min(250px, 100%), 1fr))", padding: "1rem" }}>
                <div style={{ position: "relative", padding: ".5rem" }}>
                    ...
                    {theme ?
                        <Image alt="Pines Dental Logo" src={require(`@/public/logo lightmode.png`).default.src} width={200} height={200} />
                        :
                        <Image alt="Pines Dental Logo" src={require(`@/public/logo darkmode.png`).default.src} width={200} height={200} />
                    }
